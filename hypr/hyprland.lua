...
hl.on("hyprland.start", function () 
  ...
  hl.exec_cmd("test -f $HOME/.config/hypr/wallpaper/live.mp4 && mpvpaper -o 'no-audio loop-file=inf panscan=1.0 hwdec=auto' '*' $HOME/.config/hypr/wallpaper/live.mp4 || hyprpaper")
